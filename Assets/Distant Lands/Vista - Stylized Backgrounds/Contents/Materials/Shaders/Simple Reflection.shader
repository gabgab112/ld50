...
Shader "Distant Lands/Vista/Simple Reflection"
{
	Properties
	{
		...
		[ASEBegin]_Offset("Offset", Float) = 0
		[ASEEnd]_Tint("Tint", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 fetchOpaqueVal1 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( appendResult5 ), 1.0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( fetchOpaqueVal1 * _Tint ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18900
225;156.5;1036;568;1396.626;306.5314;1.6;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-142.2258,32.66856;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=491BE524F96EE5606F52BD4C7F6F05B795E9B6B8