...
Shader "Distant Lands/Stylized Sky Shader"
{
	Properties
	{
		...
		[ASEBegin][HDR]_ZenithColor("Zenith Color", Color) = (0.3063813,0.6443705,0.764151,1)
		[HDR]_HorizonColor("Horizon Color", Color) = (0.8111427,1.574054,1.849057,1)
		[ASEEnd]_GradientMultiplier("Gradient Multiplier", Float) = 1
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float4 clampResult7 = clamp( ( _GradientMultiplier * IN.ase_color ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 lerpResult4 = lerp( _HorizonColor , _ZenithColor , clampResult7);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult4.rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18900
225;156.5;1036;568;1448.302;158.2752;1.6;True;False
...
ASEEND*/
//CHKSM=38CA6EB91E38103F8A71EA2E0DA367F87E3F34CE